		...
		//https://docs.spring.io/spring-security/reference/5.8/servlet/exploits/csrf.html
			...
			.authorizeHttpRequests(authorize->
				authorize
					...
					.antMatchers("/","/signin","/signup","/admin","/reply","/goods/**","/common/**" ).permitAll()//Specify that URLs are allowed by anyone.
			...
			.formLogin(login->//{}
				//*
				login
					.loginPage("/signin") //로그인 페이지 이동
					.loginProcessingUrl("/signin") //form action과 일치하게 설정 post
					.usernameParameter("id") //Defaults "username".
